...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
                    ...
                    <form method="post" action="index.php" class="form-horizontal">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Masukkan Tanggal Lahir" autocomplete="off" type="text" name="tgl_lahir" id="tgl_lahir" class="form-control">
                                </div>
                            </div>
            ...
            $pasien_hardcode = ['kodePasien' => 'FX-PAS-001', 'tanggal' => '16-04-2022', 'nama' => 'Fadhil', 'jk' => 'Pria', 'bb' => 90, 'tb' => 175, 'bmi' => 25.71, 'status' => 'Kelebihan berat badan'];
