...
$mahasiswa1 = new Mahasiswa('Fahri', getRandomNim());
$mahasiswa2 = new Mahasiswa('Ana', getRandomNim());
$mahasiswa3 = new Mahasiswa('Sari', getRandomNim());
$mahasiswa4 = new Mahasiswa('Ali', getRandomNim());
...
<body>
    <div class="container-fluid">
        ...
        <div class="table-responsive my-5">
            <table id="table-mahasiswa" class="table table-success table-striped">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>NIM</th>
