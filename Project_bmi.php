    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Aplikasi Penghitung BMI</h3>
                    ...
                    <form method="post" action="Project_bmi.php" class="form-horizontal">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="icheck-primary d-inline mr-1">
                                        ...
                                        <label for="laki_laki">Pria
                                        </label>
                                    </div>
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" id="wanita" name="jk" value="P">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Isi dengan Angka " autocomplete="off" type="text" name="tgl_lahir" id="tgl_lahir" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="bb" id="bb" required class="form-control" placeholder="Isi dengan angka">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="tb" id="tb" required class="form-control" placeholder="Isi dengan Angka">
                                </div>
                            </div>
            ...
            $pasien_hardcode = ['kodePasien' => 'FX-PAS-001', 'tanggal' => '16-04-2022', 'nama' => 'kuntum', 'jk' => 'Pria', 'bb' => 90, 'tb' => 175, 'bmi' => 21.75, 'status' => 'Kelebihan Berat Badan', 'image' => 'kurus'];
            ...
            ?>
                <div class="card-body" id="hasil">
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Hasil Data BMI</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
